...
\draw [arrow,very thick] (16.5,-4) -- node [above] {} (18,-4);

\draw [arrow,very thick] (18,-4) -- node [above] {} (18,-7);

\draw [arrow,very thick] (18,-7) -- node [above] {} (-1,-7);

\draw [arrow,very thick] (-1,-7) -- node [above] {} (-1,-10);
...
\draw [->,very thick]  (10.5,-10) -- node [above] {$\iota \circ \chi$} (11.5,-10) ;

\foreach \x in {12,13,...,16}{
    \node[box,fill=orange ] at (\x,-8){};
    \node[box,fill=orange ] at (\x,-9){};
    \node[box,fill=orange ] at (\x,-10){};
    \node[box,fill=orange ] at (\x,-11){};
    \node[box,fill=orange ] at (\x,-12){};
}
...
\draw[very thick] (17.5,-9) -- (17.5,-11) -- (19.5,-11) -- (19.5,-9) -- (17.5,-9);

\node at (18.5,-10){\huge $C$};

\draw [->,very thick]  (16.5,-10) -- node [above] {$\theta$} (17.5,-10) ;

\draw[ultra thick] (20.7,-9.5) -- (20.7,-10.5);

\draw [->,very thick]  (19.5,-10) -- node [above] {$\pi \circ \rho$} (20.5,-10) ;

\draw [<-,very thick]  (20.9,-10) -- node [above] {$\chi^{-1} \circ \iota^{-1}$} (22.6,-10) ;
