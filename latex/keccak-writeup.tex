...
Then we can apply the same technique as mentioned in section 6.3 \cite{} for this structure also. We linearize the $C[x][y][z]$ term as in $(14)$. We can match $2\floor*{\frac{t - 5}{8}}$ bits of a given hash value if we have $t$ variables.
