...
\section{Preimage attack on 3-round \KECCAK-224}

In this section, we discuss a preimage attack for 3-round \KECCAK{}-$224$ where we try to keep the first 2 rounds linear and then build a system of 128 linear equations on 128 variables from the 224-bit hash.
